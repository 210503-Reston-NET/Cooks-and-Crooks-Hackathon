...
namespace RRBL
{
    public class ReservationBL : IReservationBL
    {
        ...
        public List<Reservation> GetReservationsByCustomerRestaurant(string id, int RestaurantId)
        {
            return _repo.GetReservationsByCustomerRestaurant(id, RestaurantId);
        }
    }
}
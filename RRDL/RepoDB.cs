...
namespace RRDL
{
    public class RepoDB : IRepository
    {
        ...
        public List<Reservation> GetReservationsByCustomerRestaurant(string customerId, int restaurantId)
        {
            List<Reservation> reservations = _context.Reservations
            .Where(reserv => reserv.RestaurantId == restaurantId && reserv.CustomerId.Equals(customerId))
            .Select(rsrv => rsrv).ToList();
